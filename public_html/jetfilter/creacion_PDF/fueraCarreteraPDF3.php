        ...
        <thead>
            <tr> 
                <th class="titulo" colspan="13">
                    <h3>Vehiculos Fuera de Carreteras</h3>
                </th>
                <th class="fecha" width= "50Px" colspan="5">
                    <img src="<?php echo $base64; ?>">
                </th>
            </tr>
            <tr>
                <th class="fecha" colspan="18"><?php echo "$fechaActual";?></th> 
            </tr>
            <tr>
                <th><h6>Modelo</h6></th>
                <th><h6>Motor</h6></th>
...
<?php
    ...
    $domPDF->render();
    $pdf = $domPDF->output();
    file_put_contents("./../PDF/fuera_de_carretera3.pdf",$pdf);
    //$domPDF->stream("dompdf_out.pdf", array("Attachment" => false));

    unlink("./../PDF/fuera_de_carretera.pdf");

    require_once('./../../librerias/fpdf185/fpdf.php');
    require_once('./../../librerias/FPDI-2.3.7/FPDI-2.3.7/src/autoload.php');
    
    $files = array("./../PDF/fuera_de_carretera1.pdf","./../PDF/fuera_de_carretera2.pdf","./../PDF/fuera_de_carretera3.pdf");
    ...
    $pdf->Output("F","./../PDF/fuera_de_carretera.pdf");
