...
<body>
    ...
    <table>
        <thead>
           <tr>
                <th class="titulo" colspan="12"><h3>Vehiculos Comerciales</h3></th>
                <th class="titulo" colspan="3"><img src="<?php echo $base64; ?>"></th>
            </tr>

              <tr ><th class="fecha" colspan="15"><?php echo "$fechaActual";?></th> </tr>
            <tr>
                <th><h6>Modelo</h6></th>
                <th><h6>Motor</h6></th>
                <th><h6>Año</h6></th>
...
unset($aplicacion);
    ...
    $domPDF->render();
    $pdf = $domPDF->output();
    file_put_contents("./../PDF/vehiculos_comerciales.pdf",$pdf);
