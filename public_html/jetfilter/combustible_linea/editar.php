<?php 
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_c.id_codigo, e_c.codigo, e_c.tipo, f_c.id_tipo, f_c.filtracion, e_c.diametroext, e_c.altura, e_c.entrada, e_c.salida, f_c.und_empaque, e_c.detalle1, e_c.detalle2
...
?>
    <title>Actualizar Datos de Productos de Combustible en Linea</title>
            ...
            <form action="update.php" id="form-especificacion" method="POST" class="form_login" enctype="multipart/form-data">
                ...
                <table class="tabla_edi">
                    ...
                    <tr>
                        ...
                        <td> 
                            <input class="edi_inp" type="number" value="<?php echo $diametro_exterior ?>" name="diametro_ext" id="diametro_ext" min="0" step=".01" required />
                        </td>  
                    </tr>
                    <tr>
                        <th>Altura:</th>
                    ...
                    <tr>
                        <th>Entrada:</th>
                        <td> 
                            <input class="edi_inp" type="number" value="<?php echo $entrada ?>" name="entrada" id="entrada" min="0" step=".01" required />
                        </td>  
                    </tr>
                    <tr>
                        <th>Salida:</th>
                        <td> 
                            <input class="edi_inp" type="number" value="<?php echo $salida ?>" name="salida" id="salida" min="0" step=".01" required />
                        </td>  
                    </tr>
                    <tr>
