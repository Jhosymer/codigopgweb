<?php
    /* -----ARCHIVO PARA ELIMINAR UN REGISTRO EN COMBUSTIBLE EN LINEA-------- */
    ...
    //Se eliminaran los registros en la tabla de combustible en linea y de filtro codificación.
    ...
    try {
        ...
        $eliminar_combustible_linea = $base_de_datos->prepare("UPDATE espec_combustiblelinea SET deleted_at = :fecha WHERE id = :id") or die('Error al eliminar');
        $eliminar_combustible_linea->bindParam(':fecha', $fecha, PDO::PARAM_STR);
        $eliminar_combustible_linea->bindParam(':id', $id, PDO::PARAM_STR);
        $eliminar_combustible_linea->execute();
    ...
    //En caso de que ocurra algún error
        ...
        $_SESSION['error'] = true;
        header("location: ./espec_combustiblelinea");
    }
