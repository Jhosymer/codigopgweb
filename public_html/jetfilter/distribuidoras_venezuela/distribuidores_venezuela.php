...
<body>
    ...
    <nav class="nav container" id ="menu_s">
        ...
        <ul class="nav__link nav__link--menu">
            ...
            <li class="nav__items">
                <a href="distribuidores_venezuela.php" class="nav__links">Distribuidores</a>
            </li>
            <li class="nav__items">
...
<div>
        <table>
            <div>
                <h2 class="catalogo">Distribuidores - Venezuela</h2>  
            </div>
            <tr>
                <td class="titulo">Distribuidores de Venezuela</td>
            </tr>
            <tr>
                <td>
                    <ul class="lista">
                        <li class="espe">
                            <a href="./detalle/espec_distribuidor.php">Detalle de los Distribuidores</a>
                        </li>
                        <li class="espe">
                            <a href="./estado/estados_distribuidores.php">Estados de los Distribuidores</a>
                        </li>
                    </ul>
                </td>
        </table>
