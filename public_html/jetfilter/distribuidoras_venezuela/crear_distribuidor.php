<?php 
    ...
    if( isset( $_POST['distribuidor'] ) ){
        ...
        $argumentos = [$nombre, $email, $telefono, $telefono2, $calificacion, $facebook, $twitter, $instagram];
        $seleccionado = $base_de_datos->prepare("INSERT INTO distribuidoras (nombre, email, pais, telefono, telefono2, calificacion, facebook, instagram, twitter) VALUES (?, ?, 'Venezuela', ?, ?, ?, ?, ?, ?)");
