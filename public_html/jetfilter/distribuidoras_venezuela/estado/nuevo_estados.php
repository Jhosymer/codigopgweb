<?php 
    ...
    $sql = "SELECT id, nombre FROM distribuidoras WHERE pais = 'Venezuela' ORDER BY nombre ASC";
            ...
            <form action="crear_estados.php" method="POST" class="formulario_aire">
                <table class="tabla_edi">
                    <tr>
                        <th>Distribuidor</th>
                        <td>
                            <select class="selectdis" name="distribuidora_id" required>
                    ...
                    <tr>
                        <td class="b_td">  
                            <input class="boton" name="enviar_estado" value="Enviar" type="submit">
                        </td>
                        <td class="b_td">  
...
<script>
   /* var estados = ['Amazonas', 'Anzoategui', 'Apure', 'Aragua', 'Barinas', 'Bolivar', 'Carabobo', 'Cojedes', 'Delta Amacuro', 'Distrito Capital', 'Falcon', 'Guarico', 'Lara', 'Merida', 'Miranda', 'Monagas', 'Nueva Esparta', 'Portuguesa', 'Sucre', 'Tachira', 'Trujillo', 'Vargas', 'Yaracuy', 'Zulia'];
    ...
    boton_agregar.addEventListener('click', () => {
        ...
        var newRow = "<tr><th>Estado</th><td><select class='selectdis' name='estado[]'>";
        var theOptions = "";
