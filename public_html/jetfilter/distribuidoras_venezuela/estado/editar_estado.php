            ...
            <form action="update_estados.php" method="POST" class="form_login" >
                ...
                ?>
                    <table class="tabla_edi">
                        ...
                        ?>
                            <tr>
                                <td colspan="2">
                                    <select id="elegir_distribucion" class="selectdis" >
                            ...
                            <tr class="estados" id="estados" >
                                ...
                                <td>
                                    <select id="estados_distribucion" name="estados_distribucion[]" class="selectdis">
                                ...
                                foreach( $distribuciones as $distri ){
                                    ?>
                                        <tr id="estados_distribucion">
                                            ...
                                            <td>
                                                <select name="estados_distribucion[]" class="selectdis">
                                                    <?php
                                                        foreach($estados as $estado_array){
                        ...
                        <tr>
                            <th class="b_td">
                                <input type="submit" value="Guardar" name="enviar_principal" class="boton" />
                            </th>
                            <?php 
                                if( $numFilaDistribuidores > 0 ){
                            ?>
                                    <td class="b_td" >
                                        <input type="button" value="+" class="boton" id="boton_mas2" />
                                    </td>
                            <?php
                                }
                                else {
                ...
                ?>
                        <table class="tabla_edi">
                            <tr>
                                <th>Estado: </th>
                                <td> 
                                    <select id="estados_venezuela" name="estados_venezuela" class="selectdis" required>
                                        <?php 
                                            foreach($estados as $estado_array){
                                                if(key($estados) == $estado){
                                                    ?>
                            ...
                            <th class="b_td">
                                <input type="submit" value="Guardar" name="enviar_distribuidora" class="boton" />
                            </th>
                        </table>
                <?php 
                    }
                ...
                ?>
                    <table class="tabla_edi">
                        ...
                        <th class="b_td">
                            <input type="submit" value="Guardar" name="enviar_nacional" class="boton" />
                        </th>
                    </table>
                <?php
                    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if( boton_mas != null ){
            boton_mas.addEventListener('click', () => {
                ...
                var newRow = "<tr><th>Estado</th><td><select class='selectdis' name='estados_distribucion[]'>";
                var theOptions = "";
        ...
        if( boton_mas != null ){
            boton_mas.addEventListener('click', () => {
                ...
                var newRow = "<tr><th>Estado</th><td><select id='estados_venezuela' name='estados_distribucion[]' class='selectdis' >";
                var theOptions = "";
                estados2.forEach( function(estado) {
                    theOptions += `<option value="${estado}">${estado}</option>`;
                });
