<?php 
    ...
    if( isset( $_POST['btnimg'] ) ){
        ...
        $argumentos = [$nombre, $email, $email2, $telefono, $telefono2, $calificacion, $facebook, $twitter, $instagram, $video_instagram, $direcmaps, $id];
        $seleccionado = $base_de_datos->prepare("UPDATE distribuidoras SET nombre = ?, email = ?, email2 = ?, telefono = ?, telefono2 = ?, calificacion = ?, facebook = ?, twitter = ?, instagram = ?, video_instagram = ?, direcmaps =? 
