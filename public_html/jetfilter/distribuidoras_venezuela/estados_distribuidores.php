...
.
    <title>Distribuidores - Estados de Venezuela</title>
    ...
    <section class="about_tabla_espe">
        <section class="about-if_tabla_esp">
            <div class="tex_tablas">
                <p>Distribuidores - Estados de Venezuela</p>
            </div>
            <div class="tex_tablas">
                <a href="./nuevo_estados.php" class="boton">Nuevo</a>
            </div>
        </section>
    ...
    <script>
        ...
        function getData(pagina){
            ...
            $.ajax({
                ...
                url: './../plantillas/cargar_distribuidoras_estado.php',
                dataType: 'json',
                type: 'POST',
