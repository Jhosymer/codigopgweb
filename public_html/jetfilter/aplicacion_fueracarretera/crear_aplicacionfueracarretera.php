<?php 
    ...
    if( isset( $_POST['codigo_filtro'] ) ){
        ...
        try {
            ...
            $crear_nueva_aplicacion = $base_de_datos->prepare("INSERT INTO aplicacion (id_tipo, id_marca, id_vehiculo, aplicacion, id_codigo, codigo, detalle, sincronizado) VALUES ('3', ?, ?, ?, ?, ?, ?, ?)");
