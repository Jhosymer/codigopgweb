...
<title>Nuevo Producto de Aplicación Fuera de Carretera</title>
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Crear Producto y Especificaciones de Aplicación Fuera de Carretera</p>
        </div>
        <div class="tex_tablas">
        ...
        <div class="tex_tablas">
            ...
            <form action="crear_aplicacionfueracarretera.php" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                <table class="tabla_edi">
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="boton" type="submit" value="Enviar" name="nueva_aplicacion_fueracarretera">
                        </td>
                        <td class="b_td">  
