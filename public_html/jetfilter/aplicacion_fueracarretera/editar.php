<?php 
    ...
    //Consulta de todas las aplicaciones de Fuera de Carretera
...
<title>Actualizar Aplicaciones Fuera de Carretera</title>
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Actualizar Aplicaciones Fuera de Carretera</p>
        </div>
        <div class="tex_tablas">
            <a href="./aplicacion_fueracarretera.php" class="boton">Atras</a>
        </div>
    </section>

    <section class="about_tabla_editar">
        <div class="tex_tablas">
                ...
                <table class="tabla_edi">
                    <input type="hidden" value="<?php echo $id ?>" name="id">
                        ...
                        <tr>
                            <th>Código WEB: </th>
                            <td>  
                                <input class="edi_inp" type="text" value="<?php echo $codigo ?>" id="codigo_web" name="codigo" id="codigo" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr><th colspan="2" style="text-align: center;">Aplicación Comercial</th></tr>
                        <tr>
                            <th>Marca: </th>
                            <td>
                                <select name="marca" class="selectdis" id="marca">
                                    <?php 
                        ...
                        <tr>
                            <th>Vehículo: </th>
                            <td>
                                <select name="vehiculo" id="vehiculo" class="selectdis">
                                    <?php 
                        ...
                        <tr>
                            <th>Aplicación: </th>
                            <td>
                                <select name="aplicacion" class="selectdis" id="marca">
                                    <?php 
                        ...
                        <tr>
                            <th>Detalle: </th>
                            <td>
                                <input class="edi_inp" type="text" value="<?php echo $detalle ?>" name="detalle" id="detalle" />
                            </td>  
                        </tr>
        ...
        <!-- Formulario para subir nuevas marcas -->
        <div>
            <div class="tex_tablas marca_nueva">
                <form action="./subir_marca_editar.php" method="POST" id="form-marca" class="formulario_aire">
                    ...
                    <table class="tabla_edi">
                        ...
                        <tr> 
                            <td class="b_td"> <input class="boton" type="submit" value="Enviar" name="marca_nueva_editar"></td>
            ...
            <div class="tex_tablas marca_nueva">
                <form action="./subir_vehiculo_editar.php" method="POST" id="form-vehiculo" class="formulario_aire">
                    ...
                    <table class="tabla_edi">
                        ...
                        <tr> 
                            <td class="b_td"> 
                                <input class="boton" type="submit" value="Enviar" name="vehiculo_nuevo_editar">
                            </td>
                            <td class="b_td">  
