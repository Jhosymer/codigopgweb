...
?>
    ...
    <title>Agregar Productos Principales</title>

    <section class="about_tabla_espe">
        <section class="about-if_tabla_esp">
            <div class="tex_tablas">
                <p>Agregar Producto Principal</p>
            </div>
            <div class="tex_tablas">
            ...
            <form action="crear_nuevos.php" method="POST" class="formulario_aire">
                <table class="tabla_edi">
                    <tr>
                        <th>Codigo</th>
                        <td>
                            <input type="text" id="codigo_filtro" name="codigo_filtro" class="codigo_filtro" required>
                        </td>
                    </tr>
                        <?php
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="boton" type="submit" value="Enviar" name="nuevo_principal">
                        </td>
                        <td class="b_td">  
