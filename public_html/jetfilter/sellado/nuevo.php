...
?>
   ...
   <title>Nuevo Producto de Sellado</title>
            ...
            <form action="crear_sellado.php" id="form-especificacion" method="POST" class="formulario_aire" enctype="multipart/form-data">
               <table class="tabla_edi">
                  ...
                  <tr>
                     ...
                     <td>
                        <input type="number" id="diametroext" name="diametroext" min="0" step=".01" required>
                     </td>
                  </tr>
                  <tr>
                     <th>Diámetro Interno:</th>
                     <td>
                        <input type="text" id="diametroint" name="diametroint" min="0" step=".01" required>
                     </td>
                  </tr>
                  <tr>
                     <th>Altura:</th>
                  ...
                  <tr>
                     <th>Valvula Al:</th>
                     <td>
                        <select name="valvulaal" id="valvulal" class="selectdis" required>
                  ...
                  <tr>
                     <th>Apertura:</th>
                     <td>
                        <input type="text" id="apertura" name="apertura" >
                     </td>
                  </tr>
                  <tr>
                     <th>Valvula Ad:</th>
                  ...
                  <tr> 
                     <td class="b_td">
                        <input class="boton" type="submit" value="Enviar" name="sellado">
                     </td>
                     <td class="b_td">
