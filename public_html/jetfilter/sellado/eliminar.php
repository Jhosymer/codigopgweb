<?php
    ...
    //Se eliminaran los registros en la tabla de sellado y de filtro codificación.
    ...
    try {
        ...
        $eliminar_sellado = $base_de_datos->prepare("UPDATE espec_sellado SET deleted_at = :fecha WHERE id = :id") or die('Error al eliminar');
        $eliminar_sellado->bindParam(':fecha', $fecha, PDO::PARAM_STR);
        $eliminar_sellado->bindParam(':id', $id, PDO::PARAM_STR);
        $eliminar_sellado->execute();
