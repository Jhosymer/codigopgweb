<?php
    ...
    try {
        ...
        $eliminar_aplicacion_comercial = $base_de_datos->prepare("UPDATE aplicacion SET deleted_at = :fecha 
                                                    WHERE id = :id") or die('Error al eliminar');
        $eliminar_aplicacion_comercial->bindParam(':fecha', $fecha, PDO::PARAM_STR);
        $eliminar_aplicacion_comercial->bindParam(':id', $id, PDO::PARAM_STR);
        $eliminar_aplicacion_comercial->execute();
