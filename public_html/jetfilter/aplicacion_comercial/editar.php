<?php 
    ...
    //Consulta de todas las aplicaciones de Comercial
    $seleccionado = $base_de_datos->prepare("SELECT aplicacion FROM aplicacion 
                                                WHERE ( deleted_at is null ) and ( id_tipo = 2 )
                                                GROUP BY aplicacion
                                                ORDER BY aplicacion");
...
<title>Actualizar Aplicaciones Comerciales</title>
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Actualizar Aplicaciones Comerciales</p>
        </div>
        <div class="tex_tablas">
