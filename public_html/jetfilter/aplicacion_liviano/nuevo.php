...
<title>Nuevo Producto de Aplicación Liviano</title>
<section class="about_tabla_espe">
    <section class="about-if_tabla_esp">
        <div class="tex_tablas">
            <p>Crear Producto y Especificaciones de Aplicación Liviano</p>
        </div>
        <div class="tex_tablas">
        ...
        <div class="tex_tablas">
            ...
            <form action="crear_aplicacionliviano.php" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                <table class="tabla_edi">
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="boton" type="submit" value="Enviar" name="nueva_aplicacion_liviano">
                        </td>
                        <td class="b_td">  
