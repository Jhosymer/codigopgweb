<?php
    ...
    alerta_nuevo('El tipo de filtro fue agregado');
    alerta_actualizado('La información del tipo fue actualizada');
    alerta_eliminado("El tipo se elimino correctamente");
?>

    <title>Especificaciones - Tipos</title>
    ...
    <?php
        ...
        ?>
            ...
            Swal.fire({
                ...
                window.location.replace( "./tipo.php" );
            })
        </script>
        <?php
            }
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Tipo</th>
                    <th>Categoria</th>
                    <th>Clasificación de Productos</th>
                    <th>Linea</th>
                    <th>Acciones</th>
                </tr>
                </thead>
    ...
    <script>
        ...
        function getData(pagina){
            ...
            $.ajax({
                ...
                url: './../plantillas/cargar_tipo.php',
                dataType: 'json',
                type: 'POST',
