    ...
    if( isset($_POST['codigo']) ){
        ...
        if( $numeroFiltros == 0 ){
            ...
            try {
                ...
                $actualizando = $base_de_datos->prepare("UPDATE filtro_codificacion SET clase = 'cabina', codigo = ?, codigo_buscar = ?, id_tipo = ?, filtracion = ?, und_empaque = ?, fecha_actualiza = ?, sincronizado = ?, updated_at = ?  WHERE id = ?") or die("Error al actualizar");
