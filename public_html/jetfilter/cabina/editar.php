...
?>
    ...
    <title>Actualizar Datos de Productos de Cabina</title>
    <section class="about_tabla_espe">
        <section class="about-if_tabla_esp">
            <div class="tex_tablas">
                <p>Actualizar Datos de Productos de Cabina</p>
            </div>
            <div class="tex_tablas">
                ...
                <form action="update.php" id="form-especificacion" method="POST" class="form_login" enctype="multipart/form-data">
                    ...
                    <table class="tabla_edi">
                        ...
                        <tr>
                            <th>Largo: </th>
                            <td>
                                <input class="edi_inp" type="number" value="<?php echo $largo ?>" name="largo" id="largo" min="0" step=".01" required />
                            </td>  
                        </tr>
                        <tr>
                            <th>Ancho: </th>
                            <td>
                                <input class="edi_inp" type="number" value="<?php echo $ancho ?>" name="ancho" id="ancho" min="0" step=".01" required/>
                            </td>  
                        </tr>
                        <tr>
                            <th>Altura: </th>
