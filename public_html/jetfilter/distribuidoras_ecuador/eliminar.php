<?php
    ...
    $base_de_datos->query("DELETE FROM distribuidoras WHERE id = $id") or die('Error al eliminar');
    header("location: espec_distribuidor.php?page=$page&registros=$registros");