<?php  
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_f.id_codigo, e_f.codigo, e_f.tipo, f_c.id_tipo, e_f.detalle1, e_f.detalle2
...
?>
    <title>Actualizar Datos de Productos de Fluidos</title>
    <section class="about_tabla_espe">
        <section class="about-if_tabla_esp">
            <div class="tex_tablas">
                <p>Actualizar Datos de Productos de Fluidos</p>
            </div>
            <div class="tex_tablas">
