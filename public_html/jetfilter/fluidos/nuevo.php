...
?>
   ...
   <title>Nuevo Producto de Fluidos</title>
   <section class="about_tabla_espe">
        <section class="about-if_tabla_esp">
            <div class="tex_tablas">
                <p>Crear Producto y Especificaciones de Fluidos</p>
            </div>
            <div class="tex_tablas">
                <a href="./fluidos.php" class="boton">Atras</a>
            </div>
        </section>
         ...
         <div class="tex_tablas">
            <form action="crear_fluidos.php" id="form-especificacion" method="POST" class="formulario_aire" enctype="multipart/form-data">
               <table class="tabla_edi">
                  ...
                  <tr> 
                     <td class="b_td"> 
                        <input class="boton" type="submit" value="Enviar" name="fluidos">
                     </td>
                     <td class="b_td">  
