...
<?php 
    ...
    $domPDF->render();
    $pdf = $domPDF->output();
    file_put_contents("./../PDF/equivalencias2.pdf",$pdf);
    //$domPDF->stream("dompdf_out.pdf", array("Attachment" => false));
   
   unlink("./../PDF/equivalencias.pdf");

    require_once('../../../librerias/fpdf185/fpdf.php');
    require_once('../../../librerias/FPDI-2.3.7/FPDI-2.3.7/src/autoload.php');
    
    $files = array("./../PDF/equivalencias1.pdf","./../PDF/equivalencias2.pdf");
    ...
    $pdf->Output("F","./../PDF/equivalencias.pdf");
