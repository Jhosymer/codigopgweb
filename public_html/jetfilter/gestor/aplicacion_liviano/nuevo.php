<?php 
     $loc = "../../../";
     $locj = "../../";
     $title = "Nuevo Aplicación Liviano";
...
?>
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Crear  Aplicación Liviano</h1>
        </div>
...
<div class="container mb-2 mt-5">
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_aplicacionliviano.php" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                 <table class="table table-striped table-hover table-responsive dataTable mt-5" id="example">
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="btn-icon me-4" type="submit" value="Enviar" name="nueva_aplicacion_liviano">
                        </td>
                        <td class="b_td">  
