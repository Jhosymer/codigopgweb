<?php
    ...
    //Se eliminaran los registros en la tabla de cabina y de filtro codificación.
    ...
    try {
        ...
        $eliminar_aire_automotriz = $base_de_datos->prepare("UPDATE espec_cabina SET deleted_at = :fecha WHERE id = :id") or die('Error al eliminar');
