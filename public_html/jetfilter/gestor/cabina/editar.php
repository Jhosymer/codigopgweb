<?php
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_p.id_codigo, e_p.codigo, e_p.tipo, f_c.id_tipo, f_c.filtracion, e_p.largo, e_p.ancho, e_p.altura, f_c.und_empaque, f_c.codigo_barra, e_p.detalle1, e_p.detalle2
                                            FROM espec_cabina as e_p
    ...
    foreach($cabina as $pan){
       ...
       // $filtracion_seleccionada = $pan['filtracion'];
        $filtracion_seleccionada = ( !isset($pan['filtracion']) ) ? null : $pan['filtracion'];
        $largo = $pan['largo'];
        $ancho = $pan['ancho'];
        $altura = $pan['altura'];
    ...
    $filtraciones = ['Estándar', 'Carbón Activo'];
?>
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Datos de Productos de Cabina</h1>
        </div>

       <a href="./espec_cabina.php"  class="btn-icon me-4" >Atrás</a>
    </div>
                    ...
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                     <table class="table table-striped table-hover table-responsive dataTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="und_empaque" value="<?php echo $und_empaque; ?>" name="und_empaque" min="0" class="form-control" >
                            </td>
                        </tr>
                        <tr>
