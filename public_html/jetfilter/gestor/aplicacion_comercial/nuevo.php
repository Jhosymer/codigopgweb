<?php 
     $loc = "../../../";
     $locj = "../../";
     $title = "Nueva - Aplicacion Comercial";
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Crear  Aplicación  Comercial</h1>
        </div>

       <a href="./aplicacion_comercial.php"  class="btn-icon me-4" >Atrás</a>
    </div>
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_aplicacioncomercial.php" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                <table class="table table-striped table-hover table-responsive dataTable">
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="btn-icon me-4" type="submit" value="Enviar" name="nueva_aplicacion_comercial">
                        </td>
                        <td class="b_td">  
