...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Datos de Productos de Sellado</h1>
        </div>
                    ...
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                     <table class="table table-striped table-hover table-responsive dataTable">
                        ...
                        <tr>
                            <th>Valvula Al: </th>
                            <td>
                                <select name="valvulaal" id="valvulaal" class="form-select" required>
                                <?php
                        ...
                        <tr>
                            <th>Apertura: </th>
                            <td>
                                <input class="form-control" type="text" value="<?php echo $apertura ?>" name="apertura" id="apertura" />
                            </td>  
                        </tr>
                        <tr>
                            <th>Valvula Ad: </th>
