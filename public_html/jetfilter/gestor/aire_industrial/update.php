    ...
    if( isset($_POST['codigo']) ){
        ...
        if( $numeroFiltros == 0 ){
            ...
            try {
                ...
                $actualizando = $base_de_datos->prepare("UPDATE espec_aireindustrial SET codigo = ?, codigo_buscar = ?, tipo = ?, diametroext1 = ?, diametroext2 = ?, diametroint1 = ?, diametroint2 = ?, altura = ?, detalle1 = ?, detalle2 = ?, sincronizado = ?, imagen = ?, imagen1 = ?, imagen2 = ?, imagen3 = ?, updated_at = ?  WHERE id = ?") or die("Error al actualizar");
