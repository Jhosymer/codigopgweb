...
<div class="container mb-2 mt-5">
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_aireindustrial.php" id="form-especificacion" method="POST" class="formulario_aire" enctype="multipart/form-data">
              <table class="table table-striped table-hover table-responsive dataTable">
                  ...
                  <tr> 
                     <td class="b_td"> 
                        <input class="btn-icon me-4" type="submit" value="Enviar" name="aire_industrial">
                     </td>
                     <td class="b_td">  
            ...
            <?php
               include_once('./../componentes/galeria_nuevo.php'); //Galeria que te permite agregar nueva imagen
            ?>
         </form>
                    </div>
                </div>
