<?php 
 $loc = "../../../";
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_a.id_codigo, e_a.codigo, e_a.tipo, f_c.id_tipo, f_c.filtracion, e_a.diametroext1, e_a.diametroext2, e_a.diametroint1, e_a.diametroint2, e_a.altura, f_c.und_empaque, e_a.detalle1, e_a.detalle2
                                                FROM espec_aireindustrial as e_a
    ...
    $categorias = categoriaDeUnProducto('Aire Industrial', $base_de_datos);
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Datos de Productos de Aire Industrial</h1>
        </div>
                    ...
                    <table class="table table-striped table-hover table-responsive dataTable">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <option value="" selected >Categoria -- Clasificacion</option>
                                <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="tipo" id="tipo" class="form-select" required>
                                    <option value="" selected >¿Cuál es el tipo?</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_exterior2 ?>" name="diametro_ext2" id="diametro_ext2" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
                            <th>Diametro Interior 1:</th>
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_int1 ?>" name="diametro_int1" id="diametro_int1" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="number" value="<?php echo $und_empaque ?>" name="und_empaque" id="und_empaque" required/>
                            </td>  
                        </tr>
                        <tr>
