<div class="row">
       ...
       <div class="col-6 mb-4"> <!-- Espaciado inferior de 4 -->
            <div class="card">
             <!-- Este Estracto solo aparecerá si hay una imagen con tamaño incorrecto -->
            <div id="precaucion_imagen-<?php echo ($i+1) ?>" style="position: absolute; background-color: white; height: 100%; color:red; justify-content: center; align-items: center">
             ...
             <!-- Fin del Estracto -->
            <img src="./../../../images/fichas-filtros/web/no-img.jpg" class="imagen mb-5" id="img-<?php echo ($i+1) ?>"></img>
            <input type="file" accept="image/jpeg" name="imagen<?php echo ($i+1); ?>" id="file-<?php echo ($i+1) ?>" class="inputfile inputfile-1 " />
