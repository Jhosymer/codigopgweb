<?php
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_f.id_codigo, e_f.codigo, e_f.tipo, f_c.id_tipo, e_f.detalle1, f_c.und_empaque, e_f.detalle2
                        FROM espec_fluidos as e_f
                        JOIN filtro_codificacion as f_c ON f_c.id = e_f.id_codigo
                        WHERE e_f.id = :id");
    ...
    foreach($fluidos as $fluido){
        $id_codigo = $fluido['id_codigo'];
        $codigo = $fluido['codigo'];
        $tipo = $fluido['tipo'];
        $id_tipo = $fluido['id_tipo'];
        $detalle1 = ( $fluido['detalle1'] == '' ) ? 'N/D' : $fluido['detalle1'];
        $detalle2 = ( $fluido['detalle2'] == '' ) ? 'N/D' : $fluido['detalle2'];
        $und_empaque = $fluido['und_empaque'];
    }
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Datos de Productos de Fluidos</h1>
        </div>
