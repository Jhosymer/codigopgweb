<?php
    $loc = "../../../";
     $locj = "../../";
     $title = "Ver - Aplicación Fuera de Carretera";
    ...
    $aplicacion_fueracarretera = $seleccionado->fetch(PDO::FETCH_ASSOC);

    $id_vehiculo = $aplicacion_fueracarretera['id_vehiculo'];
    $id_marca = $aplicacion_fueracarretera['id_marca'];
...
?>
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Ver Aplicación Fuera de Carretera</h1>
        </div>
     ...
     <div class="card h-100 mb-5">
            <table class="table table-striped table-hover table-responsive dataTable">
                ...
                <th>Aplicación:</th>
                    <td>
                        <?php
                            echo $aplicacion_fueracarretera['aplicacion'];
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php
                            echo $aplicacion_fueracarretera['codigo'];
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php
                            echo $aplicacion_fueracarretera['detalle'];
                        ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php
                            echo $aplicacion_fueracarretera['sincronizado'];
                        ?>
                    </td>
                </tr>
            </table>
