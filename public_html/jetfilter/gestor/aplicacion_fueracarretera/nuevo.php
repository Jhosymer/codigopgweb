...
?>
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Crear  Fuera de Carretera</h1>
        </div>

       <a href="./aplicacion_fueracarretera.php"  class="btn-icon me-4" >Atrás</a>
    </div>
...
<div class="container mb-2 mt-5">
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_aplicacionfueracarretera.php" method="POST" id="nuevo-formulario" class="formulario_aire" enctype="multipart/form-data">
                <table class="table table-striped table-hover table-responsive dataTable mt-5" id="example">
                    ...
                    <tr>
                        <th>Código WEB:</th>
                        <td>
                            <input type="text" class="form-control" id="codigo_web" name="codigo_filtro" class="codigo_filtro" required>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr> 
                        <td class="b_td"> 
                            <input class="btn-icon me-4" type="submit" value="Enviar" name="nueva_aplicacion_fueracarretera">
                        </td>
                        <td class="b_td">  
            ...
            <div class="tex_tablas marca_nueva mb-5">
                    <form action="./subir_marca.php" method="POST" id="form-marca" class="formulario_aire">
                        <table class="table table-striped table-hover table-responsive dataTable">
                            ...
                            <tr>
                                <td><b>Marca: </b></td>
                                <td><input class="form-control" type="text" id="marca" name="marca" required></td>
                            </tr>        
                            <tr> 
                                <td class="b_td"> 
            ...
            <div class="tex_tablas marca_nueva">
                <form action="./subir_vehiculo.php" method="POST" id="form-vehiculo" class="formulario_aire">
                    <table class="table table-striped table-hover table-responsive dataTable">
                        ...
                        <tr>
                            <th>Modelo: </th>
                            <td><input  class="form-control" type="text" id="modelo" name="modelo" required></td>
                        </tr>    
                        <tr>
                            <th>Motor: </th>
                            <td><input  class="form-control" type="text" id="motor" name="motor" required></td>
                        </tr>  
                        <tr>
                            <th>Cilindrada: </th>
                            <td><input class="form-control" type="text" id="cilindrada" name="cilindrada" required></td>
                        </tr>  
                        <tr>
                            <th>Año: </th>
                            <td><input  class="form-control" type="text" id="ano" name="ano" required></td>
                        </tr>  
                        <tr> 
                            <td class="b_td"> 
