<?php
    $loc = "../../../";
     $locj = "../../";
     $title = "Editar- Aplicacion Agricola";
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Editar  Aplicación Agrícola</h1>
        </div>
                        ...
                        <table class="table table-striped table-hover table-responsive dataTable">
                            <input type="hidden" value="<?php echo $id ?>" name="id">
                                ...
                                <tr>
                                    <th>Código WEB: </th>
                                    <td>  
                                        <input class="form-control" type="text" value="<?php echo $codigo ?>" id="codigo_web" name="codigo" id="codigo" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                ...
                                <tr><th colspan="2" style="text-align: center;">Aplicación Agrícola</th></tr>
                                <tr>
                                    <th>Marca: </th>
                                    <td>
                                ...
                                <tr>
                                    <th>Detalle: </th>
                                    <td>
                                        <input class="form-control" type="text" value="<?php echo $detalle ?>" name="detalle" id="detalle" />
                                    </td>  
                                </tr>
