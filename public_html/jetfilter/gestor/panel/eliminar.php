<?php
    /* -----ARCHIVO PARA ELIMINAR UN REGISTRO EN PANEL-------- */
    ...
    //Se eliminaran los registros en la tabla de panel y de filtro codificación.
    ...
    try {
        ...
        $eliminar_aire_automotriz = $base_de_datos->prepare("UPDATE espec_panel SET deleted_at = :fecha WHERE id = :id") or die('Error al eliminar');
