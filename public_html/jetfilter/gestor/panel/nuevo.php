...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Crear Producto y Especificaciones Panel</h1>
        </div>
...
<div class="container mb-2 mt-5">
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_panel.php" method="POST" class="formulario_aire" enctype="multipart/form-data">
               <table class="table table-striped table-hover table-responsive dataTable">
                  ...
                  <tr> 
                     <td class="b_td">
                        <input class="btn-icon"  class="form-control" type="submit" value="Enviar" name="panel">
                     </td>
                     <td class="b_td">
