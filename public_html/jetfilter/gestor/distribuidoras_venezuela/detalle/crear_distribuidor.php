<?php 
    ...
    if( isset( $_POST['distribuidor'] ) ){
        ...
        $argumentos = [$nombre, $email, $email2, $telefono, $telefono2, $calificacion, $facebook, $twitter, $instagram, $video_instagram, $direcmaps];
        $seleccionado = $base_de_datos->prepare("INSERT INTO distribuidoras (nombre, email, email2, pais, telefono, telefono2, calificacion, facebook, instagram, twitter, video_instagram, direcmaps ) VALUES (?, ?, ?, 'Venezuela', ?, ?, ?, ?, ?, ?,?,?)");
