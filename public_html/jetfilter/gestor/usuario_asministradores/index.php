...
<div class='container light color_blanco py-3 mt-5 overflow-auto rounded '>
  ...
  <h1 class="titulo text-center ">Usuarios Administradores</h1>
  ...
  <button type="submit" class="btn-icon mt-5 mb-3" name="nuevo">nuevo</button>
    ...
    <table class="table table-striped table-hover color_blanco table-responsive table-bordered" id="example" cellspacing="0" width="100%">
      ...
      <tbody>
        <?php
        $contador = 1;
        $wsqli = "SELECT * FROM `users` where rol = 1";
        ...
        <tr>
          ...
          <td class="text-center">
            <button type="button" class='btn btn-primary mb-2' data-bs-toggle="modal" data-bs-target="#editarusuarioadminModal-<?php echo $id; ?>">
...
<?php  
include("modal_editar_usuarioadmin.php");
