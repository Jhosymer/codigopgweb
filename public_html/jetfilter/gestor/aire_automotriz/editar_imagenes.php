<?php 
     $loc = "../../../";
     $locj = "../../";
     $title = "Actualizar Imagenes - Aire Automotriz";
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Imagenes de Productos de Aire Automotriz</h1>
        </div>
...
<div class="container mb-2 mt-5">
    <div class="card h-100 mb-5">
        ...
        <form action="update_imagenes.php" method="POST" class="form_login" id="editar_imagenes" enctype="multipart/form-data">
            ...
            ?>
            <tr>
                <td class="b_td"><input type="submit" value="Guardar" name="btnimg" class="btn-icon" /></td>
            </tr>
