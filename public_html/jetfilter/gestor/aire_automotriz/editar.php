<?php
 $loc = "../../../";
    ...
    $seleccionado = $base_de_datos->prepare("SELECT e_a.id_codigo, e_a.codigo, e_a.tipo, f_c.id_tipo, f_c.filtracion, f_c.und_empaque, e_a.diametroext1, e_a.diametroext2, e_a.diametroint1, e_a.diametroint2, e_a.altura, e_a.detalle1, e_a.detalle2
                                                FROM espec_aireautomotriz as e_a
    ...
    foreach($aire_automotriz as $aire){
        $id_codigo = $aire['id_codigo'];
        $codigo = $aire['codigo'];
        $tipo = $aire['tipo'];
        $filtracion_seleccionada = ( !isset($aire['filtracion']) ) ? null : $aire['filtracion'];
        $id_tipo = $aire['id_tipo'];
        $diametro_exterior1 = $aire['diametroext1'];
        $diametro_exterior2 = $aire['diametroext2'];
        $diametro_int1 = $aire['diametroint1'];
        $diametro_int2 = $aire['diametroint2'];
        $altura = $aire['altura'];
        $und_empaque = $aire['und_empaque'];
        $detalle1 = ( $aire['detalle1'] == '' ) ? 'N/D' : $aire['detalle1'];
        $detalle2 = ( $aire['detalle2'] == '' ) ? 'N/D' : $aire['detalle2'];
    }
    ...
    $categorias = categoriaDeUnProducto('Aire Automotriz', $base_de_datos);
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Actualizar Datos de Productos de Aire Automotriz</h1>
        </div>

       <a href="./espec_aireautomotriz.php"  class="btn-icon me-4" >Atrás</a>
    </div>
                ...
                <form action="update.php" id="form-especificacion" method="POST" class="form_login" enctype="multipart/form-data">
                    ...
                    <table class="table table-striped table-hover table-responsive dataTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_exterior1 ?>" name="diametro_ext1" id="diametro_ext1" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" onblur="this.value = parseFloat(this.value).toFixed(2)" required />
                            </td>  
                        </tr>
                        <tr>
                            <th>Diámetro Exterior 2: </th>
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_exterior2 ?>" name="diametro_ext2" id="diametro_ext2" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
                            <th>Diámetro Interior 1:</th>
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_int1 ?>" name="diametro_int1" id="diametro_int1" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
                            <th>Diámetro Interior 2: </th>
                            <td>
                                <input class="form-control" type="number" value="<?php echo $diametro_int2 ?>" name="diametro_int2" id="diametro_int2" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
                            <th>Altura: </th>
                            <td>
                                <input class="form-control" type="number" value="<?php echo $altura ?>" name="altura" id="altura" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" onblur="this.value = parseFloat(this.value).toFixed(2)" required/>
                            </td>  
                        </tr>
                        <tr>
