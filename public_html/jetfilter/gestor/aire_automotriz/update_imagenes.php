<?php 
    ...
    if( isset( $_POST['btnimg'] ) ){
        ...
        try {
            ...
            $seleccionado = $base_de_datos->prepare("UPDATE espec_aireautomotriz SET sincronizado = ?, imagen = ?, imagen1 = ?, imagen2 = ?, imagen3 = ?, updated_at = ?  WHERE id = ?");
    ...
    //Si se pulson un boton para eliminar imagenes
        ...
        try {
            ...
            if( $_POST['imagen_eliminada'] == 'button-eliminar-imagen1' ){
                $sql = "UPDATE espec_aireautomotriz SET sincronizado = :sincronizado, imagen = '' WHERE id = :id";
            }
            else if( $_POST['imagen_eliminada'] == 'button-eliminar-imagen2' ){
                $sql = "UPDATE espec_aireautomotriz SET sincronizado = :sincronizado, imagen1 = '' WHERE id = :id";
            }
            else if( $_POST['imagen_eliminada'] == 'button-eliminar-imagen3' ){
                $sql = "UPDATE espec_aireautomotriz SET sincronizado = :sincronizado, imagen2 = '' WHERE id = :id";
            }
            else if( $_POST['imagen_eliminada'] == 'button-eliminar-imagen4' ){
                $sql = "UPDATE espec_aireautomotriz SET sincronizado = :sincronizado, imagen3 = '' WHERE id = :id";
            }
