<?php
     $loc = "../../../";
     $locj = "../../";
     $title = "Especificaciones - Elementos";
...
?>
    ...
    <title>Especificaciones - Elemento</title>
    ...
    <?php
        ...
        ?>
            ...
            Swal.fire({
                ...
                window.location.replace("espec_elemento.php");
            })
        </script>
        <?php
            }
...
<script>
        ...
        function getData(pagina){
            ...
            formData.append('tabla', 'espec_elemento');
