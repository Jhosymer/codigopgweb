<?php
    /* -----ARCHIVO PARA ELIMINAR UN REGISTRO EN ELEMENTO-------- */
  ...
  include_once('../../../config/conexion.php');
    ...
    //Se eliminaran los registros en la tabla de elemento y de filtro codificación.
    ...
    try {
        ...
        $eliminar_elemento = $base_de_datos->prepare("UPDATE espec_elemento SET deleted_at = :fecha WHERE id = :id") or die('Error al eliminar');
        $eliminar_elemento->bindParam(':fecha', $fecha, PDO::PARAM_STR);
        $eliminar_elemento->bindParam(':id', $id, PDO::PARAM_STR);
        $eliminar_elemento->execute();
    ...
    //En caso de que ocurra algún error
        ...
        $_SESSION['error'] = true;
        header("location: ./espec_elemento");
    }