...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Crear Producto y Especificaciones Elementos</h1>
        </div>

       <a href="./espec_elemento.php"  class="btn-icon me-4" >Atrás</a>
    </div>
...
<div class="container mb-2 mt-5">
       ...
       <div class="card h-100 mb-5">
            ...
            <form action="crear_elemento.php" id="form-especificacion" method="POST" class="formulario_aire" enctype="multipart/form-data">
           <table class="table table-striped table-hover table-responsive dataTable">
                  ...
                  <tr>
                     ...
                     <td>
                        <input type="number"  class="form-control" id="diametro_ext" name="diametro_ext" min="0" step=".01" onblur="this.value = parseFloat(this.value).toFixed(2)" required>
                     </td>
                  </tr>
                  <tr>
               ...
               <tr> 
                  ...
                  <tr> 
                     <td class="b_td"> 
                        <input class="btn-icon" type="submit" value="Enviar" name="elemento">
                     </td>
                     <td class="b_td"> 
