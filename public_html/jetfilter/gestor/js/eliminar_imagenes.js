...
arreglo = ['button-eliminar-imagen1', 'button-eliminar-imagen2', 'button-eliminar-imagen3', 'button-eliminar-imagen4'];
            ...
            botones.addEventListener('click', () => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('imagen_eliminada').value = element;
                        document.getElementById('editar_imagenes').submit();
                    }
                })
            })
        }
