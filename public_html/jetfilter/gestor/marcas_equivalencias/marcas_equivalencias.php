<?php 
    ...
    alerta_nuevo();
    alerta_actualizado('La Equivalencia ha sido actualizada');
    alerta_eliminado("La Equivalencia se ha eliminado correctamente");
?>
 ...
 <div class="d-flex justify-content-between align-items-center mt-5 mb-2">
        <div class="text-center flex-grow-1">
            <h1 class="titulo">Marcas - Equivalencia</h1>
        </div>
    ...
    <script>
        ...
        function getMarcas(pagina){
            ...
            $.ajax({
                ...
                url: './plantilla_marca_equivalencia.php',
                dataType: 'json',
                type: 'POST',
