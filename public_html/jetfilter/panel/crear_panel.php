    ...
    if( isset( $_POST['codigo'] ) ){
        ...
        if( $numeroFiltros == 0 ){
            ...
            try {
                ...
                $sql = "INSERT INTO filtro_codificacion (id, clase, codigo, codigo_buscar, id_tipo, filtracion, descripcion, precio, und_empaque, fecha_actualiza, sincronizado, deleted_at, updated_at) VALUES (?, 'panel', ?, ?, ?, ?, ?, 0, ?, ?, ?, null, null)";
                $seleccionado = $base_de_datos->prepare($sql);
