...
if (isset($_POST['codigo'])) {
    ...
    or ($coincidencia_exacta_equivalencias->rowCount() > 0) or ($seleccionado_equivalencia->rowCount() > 0 ) ){
        ...
        $output['especificaciones'] .= "<table class='table table-borderless table-custom table-codigos-web'>";
        $output['especificaciones'] .= "<thead>";
        $output['especificaciones'] .= "<tr><th>Codigos WEB</th></tr>";
        $output['especificaciones'] .= "</thead>";
        $output['especificaciones'] .= "<tbody>";
        
        while($row = $coincidencia_exacta_automotriz->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=aireautomotriz&cod=1' class='link resaltar'>";
        ...
        while($row = $coincidencia_exacta_industrial->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=aireaindustrial&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $coincidencia_exacta_combustible->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=combustible&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }
        while($row = $coincidencia_exacta_elemento->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=elemento&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $coincidencia_exacta_panel->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=panel&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $coincidencia_exacta_sellado->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=sellado&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }   
        ...
        while($row = $coincidencia_exacta_fluidos->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=fluidos&cod=1' class='link resaltar'>";
            $output['especificaciones'] .= $row['codigo'] . "[*]";
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $seleccionado1->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=aireindustrial&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $seleccionado3->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=combustible&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        while($row = $seleccionado4->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=elemento&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        while($row = $seleccionado5->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=panel&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        while($row = $seleccionado6->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=sellado&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        while($row = $seleccionado7->fetch()){ 
            $codigo = $row['codigo'];
            $output['especificaciones'] .= "<tr><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=fluidos&cod=1' class='link'>";
            $output['especificaciones'] .= $row['codigo'];
            $output['especificaciones'] .= "</a></td></tr>";
        }
        ...
        $output['equivalencias'] .= "<table class='table table-borderless table-custom table-equivalencias'>";
        $output['equivalencias'] .= "<thead>";
        $output['equivalencias'] .= "<tr><th class='header-negro' colspan='3'>Codigos de Otros Fabricantes</th>";
        $output['equivalencias'] .= "<th class='header-rojo'>Codigo WEB</th></tr>";
        $output['equivalencias'] .= "</thead>";
        $output['equivalencias'] .= "<tbody>";

        while($row = $coincidencia_exacta_equivalencias->fetch()){ 
            $codigo = $row['codigo'];
            $output['equivalencias'] .= "<tr><td><span>";
            $output['equivalencias'] .= $row['codigo_marca'] . "[*]";
            $output['equivalencias'] .= "</span></td><td>";
            $output['equivalencias'] .= $row['marca'];
            $output['equivalencias'] .= "</td><td>";
            $output['equivalencias'] .= "->";
            $output['equivalencias'] .= "</td><td><a href='./../ficha_tecnica/index.php?codigo=$codigo&clase=aireaindustrial&cod=1' class='link'>";
            $output['equivalencias'] .= $row['codigo'];
            $output['equivalencias'] .= "</a></td></tr>";
        }
        while($row = $seleccionado_equivalencia->fetch()){ 
            $codigo = $row['codigo'];
            $output['equivalencias'] .= "<tr><td>";
            $output['equivalencias'] .= $row['codigo_marca'];
            $output['equivalencias'] .= "</td><td>";
            $output['equivalencias'] .= $row['marca'];
            $output['equivalencias'] .= "</td><td>";
        ...
        $output['especificaciones'] .= '<td>';
        $output['especificaciones'] .= '<p class ="mb-4">Se ha procesado la búsqueda, pero el código suministrado no ha encontrado coincidencia con nuestros registros</p>';
        $output['especificaciones'] .= '<a onclick="submitform(); return false" class="btn-icon mt-5 mb-5">Realizar Requerimiento de Filtro</a>';
        $output['especificaciones'] .= '</td>';
        $output['especificaciones'] .= '</tr>';
        ...
        $output['equivalencias'] .= "<th class='header-rojo'>Codigo WEB</th></tr>";
        $output['equivalencias'] .= "</thead>";
        $output['equivalencias'] .= "<tbody><tr><td colspan='4'></td></tr></tbody></table>";
    ...
    // Si no se envió 'codigo' (acceso directo sin POST)
