<?php
   ...
   // echo "hola desde espec_panel.class.php<br>";

   
    class espec_panel extends conexion{
       
        private $table  ="espec_panel";
        private $id     ="";
        private $codigo ="";

        // funciones GET
        public function listarespec_panel(){
        ...
        public function listarespec_panelId($id){
            $_respuestas = new respuestas;
        ...
        public function listarespec_panelCodigo($codigo){
            $_respuestas = new respuestas;
        ...
        public function listarespec_panelTotal(){
            $_respuestas = new respuestas;
