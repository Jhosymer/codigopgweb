<?php
   ...
   // echo "hola desde espec_aireautomotriz.class.php<br>";

   
    class espec_aireautomotriz extends conexion{
       
        private $table  ="espec_aireautomotriz";
        private $id     ="";
        private $codigo ="";

        // funciones GET
        public function listarespec_aireautomotriz(){
        ...
        public function listarespec_aireautomotrizId($id){
            $_respuestas = new respuestas;
        ...
        public function listarespec_aireautomotrizCodigo($codigo){
            $_respuestas = new respuestas;
        ...
        public function listarespec_aireautomotrizTotal(){
            $_respuestas = new respuestas;
