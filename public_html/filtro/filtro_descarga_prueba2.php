...
<head>
      ...
      <!-- / <link href="https://fonts.googleapis.com/css2?family=Libre+Barcode+128&family=Permanent+Marker&family=Roboto:wght@500&display=swap" rel="stylesheet"> barra sin numero-->
...
<header>
 <table class="table_pdf">
            ...
            <tr>
                <th><p class="titulo_detalle">Ficha Tecnica</p></th><td><p class="titu"><b><?php echo $codigo ; ?></b></p></td><td > <div style="text-align: right;"><img src='https://webtest.webfiltros.com/img/logo/web.png' alt='logo' class='logo_imagen'></div></td>
            </tr>
...
<table class="table_pdf">
   <tr>
           <td>
           <img src='https://webfiltros.com/filtro/libreria/resultado.png?t=<?php echo $rann?>' class="img_qr"/>
            <p class="right_txt"> <b>Ir a la Web</b></p>
         </td>
           <td><img src='https://webfiltros.com/img/img/DondeCompra.png' alt='logo' class='img_qr left'>
           <p class="txt_comprar"><b>¿Donde Comprar?</b></p>
           </td>
            <td><img src='https://webfiltros.com/img/logo/logojf1.png' alt='logo' class='logo_imagen_pie'>
            <p class="pie_pg  right_jf"> Fabricado por Jetfilter, C.A,  Tinaquillo EDO. Cojedes, www.webfiltros.com,   RIF J- 00059322-1 </p>
            </td>
    </tr>
