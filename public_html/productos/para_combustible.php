...
<title>Filtro para Combustible</title>
...
<?php
    ...
    $sql = "SELECT cat.categoria FROM categorias as cat
                    ...
                    WHERE ( p.nombre = 'Combustible' ) and ( cat.deleted_at is null )  and ( p.deleted_at is null )
...
?>
    <div class="aplicacion_producto">
        <div class="grid_productos">
            <h1 class="nombre_prod">Filtro para Combustible</h1>
                        ...
                        <div data-category="<?php echo $cat; ?>" class="clase2" >
                            <div class="about_fitros_productos" id="about_fitros_productos">
                                <div class="div_img_pro" style="cursor: pointer;" >
                                    ...
                                    ?>
                                            <img src="./../img/productos/ISU_2.png" data-value="<?php echo $cat; ?>" class="img_prod" alt="FILTRO TIPO ELEMENTO">
                                    <?php
                                        }
                                        else if( $categoria['categoria'] == "ACOPLE RAPIDO" ){ 
                                            ?>
                                                    <img src="./../img/productos/WPS-7407A.png" data-value="<?php echo $cat; ?>" class="img_prod" alt="FILTRO TIPO ACOPLE RAPIDO">
                                            <?php
                                                }
                                        else if( $categoria['categoria'] == "PORTA FILTROS" ){ 
                                            ?>
                                                <img src="./../img/productos/WT-900.png" data-value="<?php echo $cat; ?>" class="img_prod" alt="FILTRO TIPO PORTA FILTROS">
                                            <?php
                                        }
                                        else {
                                    ?>
    ...
    function getData(){
        ...
        .then(
            data => {
                ...
                history.replaceState(null, "", `./p_combustible.php?categoria=${categoria}&clase=${data.clase}`);
            }
    ...
    function getFiltro(){
        ...
        .then(
            data => {
                ...
                history.replaceState(null, "", `./p_combustible.php?categoria=${categoria}&tipo=${tipo}&clase=${clase}`);
            }
