...
?>
    <div class="aplicacion_producto">
        <div class="grid_productos">
            <h1 class="nombre_prod">Fluidos</h1>
                        ...
                        <div data-category="<?php echo $cat; ?>" class="clase2" >
                            <div class="about_fitros_productos" id="about_fitros_productos">
                                <div class="div_img_pro" style="cursor: pointer;" >
                                    <?php 
                                        if( $categoria['categoria'] == "REFRIGERANTE" ){ 
                                    ?>
                                            <img src="./../img/productos/refrigerante.png" data-value="<?php echo $cat; ?>" class="img_prod" alt="FILTRO TIPO REFRIGERANTE ">
                                    <?php
                                        }
                                        else {
                                    ?>
    ...
    function getData(){
        ...
        .then(
            data => {
                ...
                history.replaceState(null, "", `./p_fluidos.php?categoria=${categoria}&clase=${data.clase}`);
            }
    ...
    function getFiltro(){
        ...
        .then(
            data => {
                ...
                history.replaceState(null, "", `./p_fluidos.php?categoria=${categoria}&tipo=${tipo}&clase=${clase}`);
            }
