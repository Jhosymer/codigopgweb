                                ...
                                <div class="card card-produ card-custom h-100 border-0 d-flex flex-row align-items-center p-3">
                                    <div class="col-2">
                                        ...
                                        if ($cat == "SELLADO ROSCABLE") {
                                            ...
                                            $alt_text = 'FILTRO TIPO SELLADO ROSCABLE';
                                        } else if ($cat == "ELEMENTO") {
                                            $image_src = $loc . 'img/productos/ISU_2.png';
                                            $alt_text = 'FILTRO TIPO ELEMENTO';
                                        } else if ($cat == "ACOPLE RAPIDO") {
                                            $image_src = $loc . 'img/productos/WPS-7407A.png';
                                            $alt_text = 'FILTRO TIPO ACOPLE RAPIDO';
                                        } else if ($cat == "PORTA FILTROS") {
                                            $image_src = $loc . 'img/productos/WT-900.png';
                                            $alt_text = 'FILTRO TIPO PORTA FILTROS';
                                        } else {
                                            $image_src = $loc . 'img/productos/w-2010.png';
                                            $alt_text = 'FILTRO GENÉRICO';
                                        }
                                        ?>
