                            ...
                            <a href="#vertipos" class="text-decoration-none text-dark card-hover-effect" data-category="<?php echo $cat; ?>">
                                <div class="card card-produ card-custom h-100 border-0 d-flex flex-row align-items-center p-3">
                                    <div class="col-2">
                                        ...
                                        $image_src = '';
                                        $alt_text = '';
                                        if ($cat == "SELLADO ROSCABLE") {
                                            $image_src = $loc . 'img/productos/aceite.png'; 
                                            $alt_text = 'SELLADO ROSCABLE';
                                        }  else if ($cat == "SELLO RADIAL") {
                                            $image_src = $loc . 'img/productos/WRA-5626.png'; 
                                            $alt_text = 'SELLADO ROSCABLE';
                                        } else if ($cat == "SELLO AXIAL") {
                                            $image_src = $loc . 'img/productos/WCA-7178.png'; 
                                            $alt_text = 'SELLO AXIAL';
                                        } else if ($cat == "FLUJO CANAL") {
                                            $image_src = $loc . 'img/productos/WCA-4702.png'; 
                                            $alt_text = 'FLUJO CANAL';
                                        }else if ($cat == "PANEL") {
                                            $image_src = $loc . 'img/productos/WA-10111.png'; 
                                            $alt_text = 'PANEL';
                                        }else if ($cat == "CARBURADO") {
                                            $image_src = $loc . 'img/productos/WCA-2718_.png'; 
                                            $alt_text = 'CARBURADO';
                                        }
                                        else {
...
<script>
    ...
    function cambiarTabla(linea){
        ...
        clases = ['aireautomotriz', 'aireindustrial'];

        // Mantengo las otras, ya que parecen ser globales o de otros productos.
        clases = clases.concat(['combustiblelinea', 'elemento', 'panel', 'sellado', 'fluidos']);
